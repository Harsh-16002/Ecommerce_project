                ...
                <tbody>
                    @foreach($recentOrders as $order)
                        ...
                        <tr>
                            ...
                            <td>{{ $order->product?->title ?? 'Archived product' }}</td>
                            <td><span class="admin-badge {{ $statusClass }}">{{ $order->status }}</span></td>
                            <td>Rs. {{ number_format((float) $order->total_price, 2) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        new Chart(salesTrendContext, {
            ...
            options: {
                ...
                scales: {
                    ...
                    y: { beginAtZero: true, grid: { color: '#eef2fa' } },
